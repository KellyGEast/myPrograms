...
public class Sym {
    private Type type;
    public int offset; // added to track offset of params and locals
    
    public Sym(Type type) {
        this.type = type;
        this.offset = 1; // start with offset of < 0 for globals
    }
...
class FnSym extends Sym {
    ...
    private int paramsSize; // track params size
    private int localsSize; // track locals size
